...
import EthereumLogo from '../assets/images/HomePage/Ethereum-icon.svg';
...
const PoolPage = ({balanceOfTokens}) => {
  ...
  const changeinput = async(e) =>{
    ...
    setAvaxValue(parseFloat(avaxSpent)/1e18)
  ...
  const addliquidity = async() =>{
    ...
    if(localStorage.getItem("walletAddress") === null || localStorage.getItem("walletAddress") === undefined || localStorage.getItem("walletAddress") === ''){                
        ...
        try{
            ...
            const mintTx = await JOKERContract.addLiquidityUser(BigInt(amount * 1e9), {
                value: (AvaxValue*1e18),
              });
                    ...
                    <div className='box_main_border'>
                        <div className='trade_now_block'>
                            <div className='trade_now_row'>
                                ...
                                <span className='Market_Cap_center_span'></span>
                                    <div className='Market_Cap_text'>
                                        ...
                                        <h5 className='mer_text_h6'>{mesupply?parseFloat(mesupply/1e9).toFixed(3):"0.0"} <span>ME</span></h5>
                                    </div>
                                    {/* <span className='Market_Cap_center_span'></span> */}
                                    {/* <div className='Market_Cap_text'>
                            ...
                            <div className='mer_dai'>
                                ...
                                <div className='mer_dai_drop' ref={contentEl} style={clicked ? { height: contentEl.current.scrollHeight } : { height: "0px" }}>
                                    {/* <div className='mer_dai_drop_row'>
                                        <div className='mer_dai_drop_text'>
                                           <li> <img src={aux} width="40" height={"40"}alt="mer_dai_drop_item_logo" /> </li>
                                            <div className='mer_text'>
                                                <h5 className='mer_text_h5'>Liquidswap</h5>
                                                <p className='Market_text_p'></p>
                                                <p className='Market_text_p'></p>
                                                <Badge>  UPCOMING </Badge> 
                                            </div>
                                            <div className='hero_btn'>
                                            <a className='hero_btn' href='https://testnet.liquidswap.com/#/add-liquidity?from=0x954586b2e53518def690ae4b05e6ddaf538ff2eea1f855af7204b78212518df7::TestCoins::MERCURY&to=0x954586b2e53518def690ae4b05e6ddaf538ff2eea1f855af7204b78212518df7::TestCoins::USDC' target="_blank" rel="noreferrer" >UPCOMINGS                                            
                                            </a>
                                            </div>
                                            <WebOffBotton WebOffBotton="Upcoming" link="#0"  />
                                          
                                            
                                        </div>
                                        <div className='mer_dai_drop_text'>
                                            <img src={pangolin} width="40" height={"40"} alt="mer_dai_drop_item_logo" />
                                            <div className='mer_text'>
                                                <h5 className='mer_text_h5'>Animeswap</h5>
                                                <p className='Market_text_p'>Liquidity: {liquiidtyvalue?parseFloat(liquiidtyvalue/100000000).toFixed(2):"0.0"}</p>
                                                <p className='Market_text_p'>APY: 111.33%</p>
                                            </div>
                                            <div className='hero_btn'>
                                            <a className='hero_btn' href="https://app.pangolin.exchange/#/pool/standard" target="_blank" rel="noreferrer" >Farm
                                            
                                            </a>
                                            </div>
                                            <WebBotton WebBotton="Farm" href="https://staging.animeswap.org/#/swap?chain=aptos_testnet"  img={View_on_Explorer_icon} />
                                        </div>
                                    </div> */}
                                ...
                                <div className='trade_now_max'>
                                    ...
                                    <div className='trade_now_row_row'>
                                        <div className='from_text_block'>
                                            ...
                                            value={AvaxValue&&amount>0?parseFloat(AvaxValue).toFixed(15):'0.00'} 
                                             />
                                        </div>
                                        <div className='max_btn_main'>
                                            <div className='max_btn'>
...
{/* </>)} */}
                    ...
                    <div className='Main_Pool_block'>
                        ...
                        <MainPoolBox11 Item ={MainPoolBoxData[1]} balanceOfTokens={balanceOfTokens}/>
                          <MainPoolBox Item={MainPoolBoxData[0]} balanceOfTokens={balanceOfTokens}/>
              ...
              <div className='swap_tokens_pop_main'>
                ...
                <div className='swap_tokens_list'>
                  ...
                  <div className='Confirm_Stack_main'>
                    ...
                    <img src={baseLogo} width="30" height={"30"}alt="mer_dai_drop_item_logo" />Pancakeswap
                      <div  className='hero_btn'>
                      <a href={`https://pancakeswap.finance/swap?chain=baseSepolia&inputCurrency=${BLACKTokenAddress}&outputCurrency=ETH`} target="_blank" rel="noreferrer">Trade</a>
