...
import avaxLogo from '../assets/images/HomePage/Ethereum-icon.svg';
...
import { BLACKTokenABI, BLACKTokenAddress, WBTCAddress, ChainlinkPriceFeedOracleAddress, ChainlinkPriceFeedOracleABI, BurnVaultAddress, BurnVaultABI } from '../abi/abi';
...
const SwapPage = ({balanceOfTokens}) => {
    ...
    if (e === "" || e === null || e === NaN || e === "." || isNaN(e) || hasMoreThan18Decimals(e)) {
        ...
        setamount(e);
        const JOKERContract = new ethers.Contract(BLACKTokenAddress, BLACKTokenABI, provider);    
        let avaxSpent = ethers.utils.formatUnits(await JOKERContract.checkSwapValue(e*1e9,[BLACKTokenAddress,WBTCAddress]),0);
 ...
 const hasMoreThan18Decimals = (value) => {
    ...
    return false;
      ...
      const maxval = async() =>{
        const JOKERContract = new ethers.Contract(BLACKTokenAddress, BLACKTokenABI, provider);
        let bala = ethers.utils.formatUnits(await JOKERContract.balanceOf(localStorage.getItem("walletAddress")),0);
        setamount((bala * 20/100)/1e9);
        let avaxSpent = ethers.utils.formatUnits(await JOKERContract.checkSwapValue(bala,[BLACKTokenAddress,WBTCAddress]),0);
        console.log("avaxSpent",parseFloat(avaxSpent/1e18))
        let feesdeductedvalue = (parseFloat(avaxSpent)*50/100)/1e18;
        setAvaxValue(feesdeductedvalue)
      }
        ...
        if(localStorage.getItem("walletAddress") === null || localStorage.getItem("walletAddress") === undefined || localStorage.getItem("walletAddress") === ''){                
            ...
            try{
               ...
               const JOKERContract = new ethers.Contract(BLACKTokenAddress, BLACKTokenABI, signer);    
                const mintTx = await JOKERContract.swapTokensForBNBUSer(BigInt(amount * 1e9));
                                    ...
                                    <div className='trade_now_row_row'>
                                        ...
                                        <div className='max_btn_main'>
                                            ...
                                            &nbsp;&nbsp;
                                                 ...
                                                 <div className='max_btn'>
                                                <a aria-disabled={false} href="#0"> <img src={mercurycoin} width={25} height={30} alt="logo" /> ME</a>
                                            </div>
                                    ...
                                    <div className='trade_now_row_row'>
                                        ...
                                        <div className='max_btn_main'>
                                            ...
                                            >
                                                ...
                                                <div className='max_btn'>
                                                <a aria-disabled={false} href="#0"> <img src={avaxLogo} width={25} height={25} alt="logo" />ETH</a>
                                            </div>
