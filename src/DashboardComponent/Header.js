...
import avaxIcon from '../assets/images/HomePage/Base-logo.png';
                    ...
                    params: [
                      {
                        ...
                        blockExplorerUrls: ['https://sepolia.basescan.org/tx/'],
                      },
                    ],
                  });
                } catch (addError) {
...
<div className='hero_btn test_btn' id='test_btn_hover' >
                                    ...
                                    <div className='cm_test_dropdown'>
                                        ...
                                        <li>
                                                <p>
                                                    <span><img src={ConnectPop_icon_2} alt="ConnectPop_icon" /> TestNet</span>
                                                    {/* <span className='test_ins'>Install </span> */}
                                                </p>
                                            </li>  
                                           <li>
                                                <p>
                                                 <span><img src={ConnectPop_icon_2} alt="ConnectPop_icon" />MainNet</span>
                                ...
                                <div className='app_button'>
                                    ...
                                    &nbsp;
                                    <a href="#0" onClick={()=>balacnce()}><img src={avaxIcon} width={25} height={25}/> &nbsp;{gbalances.eth?parseFloat(gbalances.eth / 1e18).toFixed(3):'0.00'}  </a>
                                    &nbsp;
